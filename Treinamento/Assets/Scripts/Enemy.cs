...
public class Enemy : MonoBehaviour {
    ...
    // dano recebido pelo inimigo enqunto ele estiver pegando fogo
    public void OnFire(Armor Current, float Life_Enemy) {
        Life_Enemy = Life_Enemy * (1 - (Current.Magic / 50));
    }
    
    // chama o dano de fogo e é responsavel por esse dano ser ao longo do tempo
    void CallFire() {
    ...
    //cancela o dano de fogo e seta fire pra false, ou seja o inimigo nao está mais em chamas
